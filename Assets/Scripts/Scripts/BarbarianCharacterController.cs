...
namespace EG
{
	...
	public class BarbarianCharacterController : MonoBehaviour
	{
		...
		private BarbarianCharacterController m_Character; // A reference to the ThirdPersonCharacter on the object
		...
		void Start()
		{
			...
			m_Character = GetComponent<BarbarianCharacterController>();
		}
		private void Update()
		{
			if (!m_Jump)
